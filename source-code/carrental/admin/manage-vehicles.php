...
<head>
	...
	<title>Just Rental |Admin Manage Vehicles   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รายการรถถเช่า</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">รายละเอียดรถเช่า</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('ต้องการจะลบหรือไม่');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
