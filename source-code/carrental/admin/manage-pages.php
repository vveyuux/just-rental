...
$query -> execute();
$msg="อัพเดทข้อมูลหน้าเว็บเรียบร้อยแล้ว";
...
<head>
	...
	<title>Just Rental | Admin Create Brand</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">จัดการหน้าเว็บ </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">ช่องแบบฟอร์ม</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ผิดพลาด</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">เลือกหน้าเว็บ</label>
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***เลือกมาหนึ่งอย่าง***</option>
                  ...
                  <option value="manage-pages.php?type=faqs">FAQs</option>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">เลือกหน้าเว็บแล้ว</label>
												<div class="col-sm-8">
						<?php
			...
			?>
									...
									<div class="form-group">
												<label class="col-sm-4 control-label">รายละเอียดข้อมูลหน้าเว็บ </label>
												<div class="col-sm-8">
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">ใช้งาน</button>
												</div>
											</div>
