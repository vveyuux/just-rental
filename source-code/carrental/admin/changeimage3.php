...
<head>
	...
	<title>Just Rental | Admin Update Image 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รูปภาพรถเช่ามุมที่ 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">รูปภาพมุมที่ 3</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">รูปภาพมุมที่ 3 ปัจจุบัน</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">อัปโหลดรูปภาพใหม่มุมที่ 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="update" type="submit">เปลี่ยน</button>
												</div>
											</div>
