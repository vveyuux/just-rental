...
$msg="คำรับรองหยุดใช้งานสำเร็จแล้ว";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รายการคำรับรอง</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">ผู้ให้คำรับรอง</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('คุณต้องการจะใช้งานหรือไม่')"> ไม่ใช้งาน</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('คุณต้องการจะหยุดใช้งานหรือไม่')"> ใช้งาน</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
