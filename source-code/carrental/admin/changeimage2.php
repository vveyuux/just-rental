...
<head>
	...
	<title>Just Rental | Admin Update Image 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รูปภาพรถเช่ามุมที่ 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">รูปภาพมุมที่ 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">รูปภาพมุมที่ 2 ปัจจุบัน</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">อัปโหลดรูปภาพใหม่มุมที่ 2<span style="color:red">*</span></label>
												<div class="col-sm-8">
