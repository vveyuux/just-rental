...
<head>
	...
	<title>Just Rental |Admin Manage Subscribers   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รายการผู้ติดตาม</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">รายละเอียดผู้ติดตาม</div>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('คุณต้องการจะลบข้อมูลหรือไม่');"><i class="fa fa-close"></i></a>
</td>
