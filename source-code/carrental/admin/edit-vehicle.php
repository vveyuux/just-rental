...
$insureOverview=$_POST['insureoverview'];
...
$msg="ข้อมูลได้อัพเดทเรียบร้อยแล้ว";
...
<head>
	...
	<title>Just Rental | Admin Edit Vehicle Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">แก้ไขรถเช่า</h2>
...
<label class="col-sm-2 control-label">ชื่อรถเช่า<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">แบรนด์<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">ภาพรวมรถเช่า<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">ราคาต่อวัน(บาท)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">เลือกเชื้อเพลิง<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">รุ่นปี<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required>
</div>
<label class="col-sm-2 control-label">จำนวนที่นั่ง<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">เปลี่ยนรูปภาพที่ 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">เปลี่ยนรูปภาพที่ 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">เปลี่ยนรูปภาพที่ 3</a>
</div>
</div>
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">เปลี่ยนรูปภาพที่ 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">เปลี่ยนรูปภาพที่ 5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">องค์ประกอบรถ</div>
<div class="panel-body">
		...
		{?>
			<div class="checkbox checkbox-inline">
				<input type="checkbox" id="inlineCheckbox1" name="airconditioner" checked value="1">
					<label for="inlineCheckbox1"> แอร์รถ </label>
			</div>
		<?php 
			} else { 
		?>
	...
	<div class="col-sm-3">
		...
		<div class="checkbox checkbox-inline">
			<input type="checkbox" id="inlineCheckbox1" name="powerdoorlocks" checked value="1">
				<label for="inlineCheckbox2"> ล็อคประตูไฟฟ้า </label>
		</div>
		<?php } else {?>
...
<label for="inlineCheckbox3"> ระบบเบรกป้องกันล้อล็อก </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> ระบบเสริมแรงเบรค </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> พวงมาลัยเพาเวอร์ </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">ถุงลมนิรภัยฝั่งคนขับ</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> ถุงลมนิรภัยฝั่งคนนั่ง </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> กระจกไฟฟ้า </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> เครื่องเล่นซีดี </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">ระบบการล็อคประตู</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> เซ็นเซอร์ตรวจจับการชน </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> เบาะหนัง </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">บันทึกการเปลี่ยนแปลง</button>
												</div>
											</div>
