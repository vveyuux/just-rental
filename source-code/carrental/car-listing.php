...
<title>Just Rental | Car Listing</title>
<!--Bootstrap -->
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            $cnt=$query->rowCount();
            ?>
            <p><span><?php echo htmlentities($cnt);?> รายการที่พบ</span></p>
          </div>
        </div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">฿<?php echo htmlentities($result->PricePerDay);?> ต่อวัน</p>
            <ul>
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">รายละเอียดเพิ่มเติม <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> ค้นหารถเช่าของคุณ </h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>ประเภทเชื้อเพลิง</option>
<option value="Petrol">น้ำมันเบนซิน</option>
<option value="Diesel">น้ำมันดีเซล</option>
<option value="CNG">แก๊ส CNG</option>
                </select>
              </div>
             
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> ค้นหารถเช่า</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> รถเช่าล่าสุด</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">฿<?php echo htmlentities($result->PricePerDay);?> ต่อวัน</p>
                </div>
              </li>
              <?php }} ?>
