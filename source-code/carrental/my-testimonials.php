...
<title>Just Rental | My Testimonials </title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>คำรับรองของฉัน</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">หน้าหลัก</a></li>
        <li>คำรับรองของฉัน</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">คำรับรองของฉัน </h5>
              ...
              <li>
                ...
                <div>
                 <p><?php echo htmlentities($result->Testimonial);?> </p>
                   <p><b>วันที่โพสต์:</b><?php echo htmlentities($result->PostingDate);?> </p>
                </div>
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">กำลังทำงาน</a>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">รอการอนุมัติ</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
